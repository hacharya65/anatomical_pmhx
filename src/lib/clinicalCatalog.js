...
export const DEFAULT_PATIENT_RECORD = {
  profile: {
    ...
    veteranStatus: "US Air Force Veteran (Honorable Discharge, 1988-1994)",
    preferredLanguage: "English",
    bloodType: "O Positive",
    pcp: "Dr. R. Adams, MD (Internal Medicine)",
    pcpPhone: "(555) 726-3000",
    clinic: "Mass General Brigham Internal Medicine Associates, Suite 400",
